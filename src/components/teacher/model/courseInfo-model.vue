<template>
  <el-dialog v-dialogDrag title="任课信息" :visible.sync="dialog" :close-on-click-modal=false append-to-body width="800px">
    <el-button type="primary" @click="add" style="margin-bottom: 10px" v-if="userInfo.level === 0"> 新增</el-button>
    <VmBaseTable
      :setTableHigh="true"
      ref="teacher_table"
      :data="dataTable"
    ...
    <div slot="footer" v-if="userInfo.level === 0">
      <el-button type="primary" @click="click" style="font-size: 18px;"> 确定</el-button>
      <el-button @click="cancel" style="font-size: 18px;"> 取消</el-button>
    </div>
  </el-dialog>
</template>
