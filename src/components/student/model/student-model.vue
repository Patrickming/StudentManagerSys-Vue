      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="班级：" prop="grade" :label-width="formLabelWidth">
            <el-input v-model="form.grade" oninput="value=value.replace(/[^0-9.]/g,'')" maxlength="15" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="入学时间：" prop="admissionTime" :label-width="formLabelWidth">
            <el-input v-model="form.admissionTime" oninput="value=value.replace(/[^0-9.]/g,'')" maxlength="15" clearable></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    <div slot="footer">
      <el-button type="primary" @click="click('form')" style="font-size: 18px;"> 确定</el-button>
  ...
  export default {
    ...
    data () {
      ...
      return {
        ...
        title: '',
        form: {
          grade: new Date().getFullYear().toString().slice(2, 4) + '01',
          realName: '',
          sex: '',
          school: '',
    ...
    methods: {
      ...
      clearForm () {
        ...
        this.form = {
          grade: year.toString().slice(2, 4) + '01',
          realName: '',
          sex: 0,
          school: '',
          admissionTime: year,
