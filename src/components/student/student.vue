<template>
  <el-card style="margin: 10px;padding: 15px 10px 10px 10px">
    <el-row style="margin-bottom: 10px">
      <el-button type="primary" style="font-size: 18px;"  @click="addMethod"> 新增</el-button>
      <el-button type="danger" style="font-size: 18px;"  @click="deleteSelect"> 删除</el-button>
      <el-input style="float:right;width:300px;" v-model="searchValue.code" placeholder="请输入学号或姓名或专业" clearable @keyup.enter.native="filterData">
